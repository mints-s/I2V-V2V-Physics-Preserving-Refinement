...
최근 Image-to-Video(I2V) 모델은 단일 이미지와 텍스트 조건으로 시간적 장면 변화를 생성할 수 있을 정도로 발전했다. 그러나 I2V 출력은 동작 단서를 포함하더라도 최종 영상의 선명도와 디테일이 충분하지 않을 수 있습니다. 별도 Video-to-Video(V2V) 정제 모델은 시각 품질을 높일 수 있지만, 강한 정제는 기준 영상의 움직임 구조를 바꿀 수 있다.
